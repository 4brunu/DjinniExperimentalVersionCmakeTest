...
class NativeHelloWorld final : ::djinni::JniInterface<::djinnicmakeexample::HelloWorld, NativeHelloWorld> {
public:
...
private:
    ...
    friend ::djinni::JniInterface<::djinnicmakeexample::HelloWorld, NativeHelloWorld>;
